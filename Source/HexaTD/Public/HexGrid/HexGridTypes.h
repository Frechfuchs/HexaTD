...
/**
 * Which map shape is used
 * @see https://www.redblobgames.com/grids/hexagons/#basics
 */
UENUM(BlueprintType)
enum class EHMapShape : uint8
{
	HEXAGON,
	RECTANGLE
};
...
struct FHTileLayout
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HGTypes|Layout")
...
struct FHAxialCoord
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HGTypes|Axial Coord")
...
struct FHCubeCoord
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HGTypes|Cube Coord")
	FIntVector QRS {
...
struct FHFractional
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "HGTypes|Fractional Coord")
...
struct FHDirections
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "HGTypes|Directions")
...
struct FHDiagonals
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "HGTypes|Diagonals")
